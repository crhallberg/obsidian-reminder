...
export abstract class ReminderSynchronizer {
    ...
    private diff(currentReminders: Array<SnapshotReminder>, newReminders: Reminders, defaultTime: Time): Array<ReminderChange> {
        ...
        idToCurrentReminders.forEach(currentReminder => {
            diff.push({ id: currentReminder.id, eventId: currentReminder.eventId, changeType: ReminderChangeType.REMOVE });
        });
...
class SnapshotCache {
    ...
    constructor(
        private cache: Array<SnapshotReminder>,
